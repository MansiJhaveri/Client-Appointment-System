...
<html>
    ...
    <body background="C:\Users\DAKSH\Desktop\Final Year Project\ProjectPhotos\xyz1.jpg">
        ...
        <br>
        <div align="center"><img src="C:\Users\DAKSH\Desktop\Final Year Project\ProjectPhotos\m.jpg" >
            <p> <font size="5">Blue Star Diamonds sources its rough directly from major miners and is vertically integrated down to selling <br> jewellery to individuals down the pipeline. Having proficient, high standard and most updated machinery, we are <br> at the forefront of the diamond industry. The core principles of long-term relationships, innovative thinking and <br> corporate social responsibility are instilled in each activity throughout the organisation. </font></p>
        </div>
        <table cellpadding="50">
            
            <tr>
                <td> <font size="4">We are amongst the world’s largest rough diamond manufacturers in the world and by sourcing directly from miners qualifying for fair diamond trading under the Kimberly Process Certification Scheme. This allows consistent and varied supply of products with one of the largest quantities in the entire marketplace. Our sourcing strength allows for constant development of rough expertise in terms of origin, quality standards, assorting and pricing.</font></td>
                <td>
                    <img src="C:\Users\DAKSH\Desktop\Final Year Project\ProjectPhotos\apg1.jpg" width="600" height="300">
                </td>
            </tr>
            <tr>
                <td>
                    <img src="C:\Users\DAKSH\Desktop\Final Year Project\ProjectPhotos\apg2.jpg" width="600" height="300">
                </td>
                <td><font size="4">
...
At Blue Star Diamonds, we meet all the requirements imposed by local and international laws and the relevant assurance programs in the diamond industry by complying with the WDC system of warranties..
                ...
                <td>
                    <img src="C:\Users\DAKSH\Desktop\Final Year Project\ProjectPhotos\apg.jpg" width="600" height="300">
                </td>
            </tr>
        </table>
